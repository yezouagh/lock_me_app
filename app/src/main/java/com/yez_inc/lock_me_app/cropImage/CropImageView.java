...
class CropImageView extends ImageViewTouchBase {
    ...
    @Override protected void zoomTo(float scale, float centerX, float centerY) {
    ...
    @Override protected void postTranslate(float deltaX, float deltaY) {
    ...
    @Override public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_UP:
                ...
                break;
            case MotionEvent.ACTION_MOVE:
                if (getScale() == 1F) {center(true, true);}
                break;
        }
        return true;
    }
