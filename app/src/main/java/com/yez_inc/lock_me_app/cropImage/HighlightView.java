...
class HighlightView {
    ...
    boolean hasFocus() {return mIsFocused;}
    void setFocus(boolean f) {mIsFocused = f;}
    void setHidden(boolean hidden) {mHidden = hidden;}
    void draw(Canvas canvas) {
		...
		mOutlinePaint.setColor(0xFF00EAFA);
            }
    ...
    void setup(Matrix m, Rect imageRect, RectF cropRect, boolean circle, boolean maintainAspectRatio) {
        if (circle) {
